...
public class PlaningController implements Serializable {
    ...
    @EJB
    private com.naturalfitness.beans.PlaningFacade ejbFacade;
    ...
    public Planing getPlaning(java.lang.Integer id) {
