...
import com.naturalfitness.beans.SecretaireFacade;
...
public class SecretaireController implements Serializable {
    ...
    @EJB
    private com.naturalfitness.beans.SecretaireFacade ejbFacade;
    ...
    public Secretaire getSecretaire(java.lang.Integer id) {
